...
const page = () => {
  ...
  const [confirmPassword, setConfirmPassword] = useState('');
    ...
    const videos = ['/videos/intro1.mp4', '/videos/intro2.mp4', '/videos/intro3.mp4'];
   ...
   const handleSignUp = async() => {
    if (
      ...
      validateConfirmPassword(password, confirmPassword)
       ...
       try {
        const response = await axios.post('/api/signups', { username, email, password });
...
<div className={Styles.container}>
    ...
    <div className={Styles.intro}> 
            <video ref={videoRef} src={videos[videoIndex]} type="video/mp4"         autoPlay loop={false} muted preload="auto" className={Styles.video}        onEnded={handleVideoEnd}        />
    </div>
    ...
    <div className={Styles.switch}>  
        ...
        {isLogin && (
            ...
            Unlock the Road Ahead
             ...
             <div className={`${Styles.icon} ${Styles.googleOutline}`}>
               <Image src='/svg/google.svg' width={20} height={20} className={Styles.googleIcon} alt="Google icon"/> 
               &nbsp;
               Continue with Google 
             </div>

              <div className={Styles.item} style={{fontSize:'1.2dvw'}}>
                   Don't have account? <span className={Styles.LoginSign} onClick={() => setIsLogin(false)}>&nbsp;Signup</span> 
             </div>
             <ToastContainer />
      ...
      <ToastContainer />
               ...
               <div className={Styles.item} style={{fontSize:'1.2dvw'}}>
                  Have account? <span className={Styles.LoginSign} onClick={() => setIsLogin(true)}>&nbsp;Login</span> 
             </div>
