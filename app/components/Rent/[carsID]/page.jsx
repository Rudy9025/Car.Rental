...
const CarDetails = () => {
    ...
    <div className={Styles.container}>
      <ToastContainer stacked/>
        ...
        <div className={Styles.carImage}>
             <Image src={car.path || '/images/placeholder.jpg'} alt={car.carName} height={600} width={600} />
        </div>
        <div style={{display:'flex',justifyContent:"space-between",backgroundColor:"#282828",width:'60%',padding:"4dvh 13dvh 4dvh 13dvh",borderRadius:'1.5dvh',color:"white"}}>
           <div className={Styles.second}>
           <p className={Styles.carTitle}>{car.carName}</p>
           <div className={Styles.secondBottom}>
           <p> <Image src='/images/icons/YM.png' width={50} height={50} alt='Year of Manufacture'/><i>Year of Manufacture:</i>{car.yearOfManufacture}</p>
            <p><Image src='/images/icons/Mileage.png' width={50} height={50} alt='Mileage'/><i>Mileage: </i>{car.mileage}</p>
            <p><Image src='/images/icons/FuelType.png' width={50} height={50} alt='FuelType'/><i>Fuel Type: </i>{car.fuelType}</p>
            <p><Image src='/images/icons/CarCategory.png' width={50} height={50} alt='CarCategory'/> <i>Car Category: </i>{car.carCategory}</p>
           </div>
            
            </div>

            <div className={Styles.third}>
            <p><Image src='/images/icons/EmissionStandard.png' width={50} height={50} alt='EmissionStandard'/><i>Emission Standard: </i>{car.emissionStandard}</p>
            <p><Image src='/images/icons/TransmissionType.png' width={50} height={50} alt='TransmissionType'/><i>Transmission Type: </i>{car.transmissionType}</p>
            <p><Image src='/images/icons/SeatCapacity.png' width={50} height={50} alt='SeatCapacity'/><i>Seat Capacity: </i>{car.seatCapacity} </p>
            <p><Image src='/images/icons/day.png' width={50} height={50} alt='day'/><i>Price per Day: </i>${car.pricePerDay}</p>
            <p><Image src='/images/icons/week.png' width={50} height={50} alt='week'/><i>Price per Week: </i>${car.pricePerWeek}</p>
            <p><Image src='/images/icons/month.png' width={50} height={50} alt='month'/><i>Price per Month: </i>${car.pricePerMonth}</p>
            </div>
           </div>
  ...
  onChange={(e) => setPickupArea(e.target.value)} 
       ...
       <span>
       Pin code:  
          <input  className={Styles.betterOutline}  placeholder="Enter Pin code"
            type="text" 
            value={pincode} 
