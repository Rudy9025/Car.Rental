    ...
    <>
      <div className={Styles.container}>
        <div className={Styles.main}>
          <NavBar />
          <div className={Styles.title}>Ride in Style</div>
          <div className={Styles.image}></div>
          <div className={Styles.status}>
            <div className={Styles.circle}>
              <div className={Styles.c}>1</div>
              <p>Explore</p>
            </div>
            <div className={Styles.circle}>
              <div className={Styles.c}>2</div>
              <p>Choose Vehicle</p>
            </div>
            <div className={Styles.circle}>
          ...
          <div className={Styles.Booking}>
            <div className={Styles.TermsConditions}>
              ...
              <p>
                Welcome to our Car Rental System! By booking, you agree to the
                terms.
              </p>
              <p>
                Rentals are available to drivers 21+ with a valid license and
                ID.
              </p>
              <p>
                Return the car in the same condition; damages may incur extra
                charges.
              </p>
              <p>
                By renting, you consent to our data collection as per the
                Privacy Policy.
              </p>
